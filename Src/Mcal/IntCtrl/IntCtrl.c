...
void IntCtrl_unpend(IntCtrl_InterruptType interrupt)
{
	uint8 UNPENDn_RegisterNumber;
	uint8 UNPENDn_BitField;
	UNPENDn_RegisterNumber=interrupt/32;
	UNPENDn_BitField=interrupt%32;
	*(UNPEND0+UNPENDn_RegisterNumber)|=(1<<UNPENDn_BitField);
